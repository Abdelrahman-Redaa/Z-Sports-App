...
abstract final class MockData {
  ...
  static final List<BookingModel> bookings = [
    BookingModel(
      ...
      stadiumImage: pitches[5].imageUrl,
      category: pitches[5].category,
      date: '2026-10-15',
      time: '20:00:00',
      durationMinutes: 60,
      totalPrice: pitches[5].pricePerHour,
    ...
    BookingModel(
      ...
      stadiumImage: pitches[1].imageUrl,
      category: pitches[1].category,
      date: '2026-10-18',
      time: '22:30:00',
      durationMinutes: 60,
      totalPrice: pitches[1].pricePerHour,
      status: BookingStatus.upcoming,
    ),
    BookingModel(
      id: 3,
      stadiumId: 4,
      stadiumName: 'نادي النخبة',
      stadiumImage: pitches[3].imageUrl,
      category: pitches[3].category,
      date: '2026-10-01',
      time: '18:00:00',
      durationMinutes: 120,
      totalPrice: pitches[3].pricePerHour * 2,
